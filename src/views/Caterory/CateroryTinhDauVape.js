...
class CateroryTinhDauVape extends Component {
    constructor(props) {
        super(props)
    }
    ...
    componentDidMount() {
        ...
        this.props.actSearchProductCaterory(VapeProducts, 'tinhDau')
    }
    render() {
...
export default (connect(Store, action)(CateroryTinhDauVape));
